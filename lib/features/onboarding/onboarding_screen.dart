...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  static const _slides = [
    OnboardingSlide(
      title: 'ابحث واعثر على وظيفتك التالية',
      subtitle: 'فرص مهنية، رسائل توظيف، وشبكة علاقات تساعدك على التحرك بثقة.',
    ),
    OnboardingSlide(
      title: 'ابن شبكتك المهنية أثناء التنقل',
      subtitle: 'تابع زملاءك، اكتشف خبراء في مجالك، وابدأ محادثات ذات معنى.',
    ),
    OnboardingSlide(
      title: 'ابق على اطلاع بمحتوى يناسب مسارك',
      subtitle: 'مقالات ومنشورات وفرص تدريب منتقاة حسب مهاراتك واهتماماتك.',
    ),
  ];
