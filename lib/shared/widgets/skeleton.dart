    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SkeletonBox(width: 58, height: 58, radius: 29),
          const SizedBox(height: 10),
          const SkeletonLine(width: 104, height: 14),
          const SizedBox(height: 7),
          const SkeletonLine(width: 118, height: 10),
          const Spacer(),
          const SkeletonLine(width: 104, height: 10),
          const SizedBox(height: 10),
          const Padding(
            padding: EdgeInsets.fromLTRB(12, 0, 12, 12),
            child: SkeletonBox(width: double.infinity, height: 30, radius: 15),
          ),
        ],
      ),
    );
